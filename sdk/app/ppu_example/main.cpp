/*!
 * @file main.cpp
 * @brief Sample application demonstrating the basic usage of the Pixel Processing Unit (PPU) in the BEEP-8 system.
 *
 * BEEP-8 includes a virtual graphics LSI called the Pixel Processing Unit (PPU). This sample provides a comprehensive overview 
 * of the fundamental features and usage of the PPU. Developers who wish to directly control the PPU can refer to this sample 
 * as a guide.
 *
 * Note: If you are using the pico8 compatible library, the PPU is abstracted away, so this sample may not be necessary.
 */
...
#define NUM_OF_TEST_LINES       (3) 
#define NUM_OF_TEST_TRIANGLES   (4) 
#define NUM_OF_TEST_RECT        (4) 

/// Use these parameters if you want to test with more elements
//#define NUM_OF_TEST_LINES       (16) 
//#define NUM_OF_TEST_TRIANGLES   (16) 
//#define NUM_OF_TEST_RECT        (32) 
